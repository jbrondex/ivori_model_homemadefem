...
if __name__ == "__main__":    
    ...
    Case_list = ['CC_3DOFs', 'CC_3DOFs', 'CC_3DOFs', 'H_MF', 'H_MF', 'H_MF', 'H_TF', 'H_TF', 'H_TF', 'H_MF', 'H_MF', 'H_MF', 'H_TF', 'H_TF', 'H_TF']
    TspSize_list = ['15min', '15min', '15min', '15min', '15min', '15min', '15min', '15min', '15min','5min', '5min', '5min', '5min', '5min', '5min']

    dt_list_MyCode = [8, 16, 96, 8, 16, 96, 8, 16, 96, 24, 48, 288, 24, 48, 288]
    color_list_MyCode = ['k', 'k', 'k', 'limegreen', 'limegreen', 'limegreen','darkred','darkred','darkred',(42/255, 127/255, 255/255), (42/255, 127/255, 255/255), (42/255, 127/255, 255/255),'orange','orange','orange']#, 'r'] ###legend for output of my code 
    Mylinesstyle_list = [':', '--', '-', ':', '--', '-', ':', '--', '-', ':', '--', '-', ':', '--', '-']
    Mylinewidth_list = [2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5]
    ...
    ax.plot(np.NaN,np.NaN, label= 'CC_3DOF; $\Delta t =15~\mathrm{min}$', color='k',linewidth= 2.5 , linestyle= '-')
    ax.plot(np.NaN,np.NaN, label= 'H_MF; $\Delta t =15~\mathrm{min}$', color='limegreen',linewidth= 2.5 , linestyle= '-')
    ax.plot(np.NaN,np.NaN, label= 'H_TF; $\Delta t =15~\mathrm{min}$', color='darkred',linewidth= 2.5 , linestyle= '-')
    ax.plot(np.NaN,np.NaN, label= 'H_MF; $\Delta t =5~\mathrm{min}$', color=(42/255, 127/255, 255/255),linewidth= 2.5 , linestyle= '-')
    ax.plot(np.NaN,np.NaN, label= 'H_TF; $\Delta t =5~\mathrm{min}$', color='orange',linewidth= 2.5 , linestyle= '-')
    ...
    name_output_fig = 'Fig_2_Papier_Hansen_Main_WithLegend'
    ...
    # SAVE THE FIGURES #####
    ################################################################################  
    name_output_fig2 = 'Fig_2_Papier_Hansen_ZoomIn_BottomcPeak_WithLegend'
    fig2.savefig(path_output_fig.joinpath(name_output_fig2))
    
    name_output_fig3 = 'Fig_2_Papier_Hansen_ZoomIn_TopcPeak_WithLegend'
