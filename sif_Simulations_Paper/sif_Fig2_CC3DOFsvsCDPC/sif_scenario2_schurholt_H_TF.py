...
Simu.Name = 'Simu_Papier_Fig2_H_TF_ProperMass_cLumped_MassnotLumped_CalPar_Alpha5minus3_SettlementOff_201nodes_24h_Output2h_Implicit_dt15min_' #Prescribed by user
...
Simu.Total_TimeSteps = 4*24 #60*24 # Total number of timesteps
Simu.Output_Interval = 4*2 # One output every X timesteps
...
Solver1.File = "Solvers.HansenHeatVap_Solver_1DOF_TForm" #In which file the solver is stored
