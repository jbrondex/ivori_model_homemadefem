...
Simu.Name = 'Simu_Papier_Fig2_CD_PC_ProperMass_cLumped_MassnotLumped_CalPar_Alpha5minus3_SettlementOff_201nodes_24h_Output2h_Implicit_dt5min_' #Prescribed by user
...
Simu.Timestep_Size = 5*60 # Delta_t in seconds (?)
Simu.Total_TimeSteps = 3*4*24 #60*24 # Total number of timesteps
Simu.Output_Interval = 3*4*2 # One output every X timesteps

Simu.Save_csv = True #True #True ### Do we want to save csv files ? True or False
Simu.Output_Path = "./Output/Output_Fig2"  #path towards where the output will be stored
...
Solver2.File = "Solvers.CalonneVap_Solver_1DOFs_KreactLumped_SourceExplicit" #In which file the solver is stored
Solver2.Name = "CalonneVap" #Solver Name
Solver2.DOFs = 1 ### For this solver DOF1= Rhov
Solver2.MassLumping = False# Do we want to lump the mass matrix ?
