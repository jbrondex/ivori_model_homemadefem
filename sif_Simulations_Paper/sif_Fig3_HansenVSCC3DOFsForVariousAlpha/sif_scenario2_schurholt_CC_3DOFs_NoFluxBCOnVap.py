...
Simu.Name = 'Simu_Papier_Fig3_CC_3DOFs_ProperMass_cLumped_CalPar_Alpha10minus3_SettlementOff_201nodes_38h_Implicit_dt15min_NoFluxVap_' #Prescribed by user
...
Simu.Total_TimeSteps = 4*38 #60*24 # Total number of timesteps
Simu.Output_Interval = 4*38 # One output every X timesteps

Simu.Save_csv = True #True ### Do we want to save csv files ? True or False
Simu.Output_Path = "./Output/Output_Fig3"  #path towards where the output will be stored
...
BF.alpha = 10**-3 #sticking coefficient
