...
Simu.Name = 'Simu_Papier_Fig6_SimsonCase7_CC_3DOFs_SettlementOn_DepOn_101nodes_20d_Output1d_Implicit_dt15min_SmoothTransition_BCNoFlux_Alpha1_' #Prescribed by user
...
BF.alpha = 1 #1e-1 #5e-3 #sticking coefficient
...
# BC1.RhovFlux = -2e-6 #If BCType_Rhov = 'Rhov Flux' : Constant or defined through USF_RhovFluxbot_Variables'
...
# BC2.RhovFlux = 1e-5# 'USF_RhovFluxbot_Variables' #If BCType_Rhov = 'Rhov Flux' : Constant or defined through USF_RhovFluxbot_Variables'
