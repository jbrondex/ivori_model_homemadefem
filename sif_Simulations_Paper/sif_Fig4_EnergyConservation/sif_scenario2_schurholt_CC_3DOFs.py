...
Simu.Name = 'Simu_Papier_Fig4_CC_3DOFs_ProperMass_cLumped_MassnotLumped_CalPar_Alpha5minus3_NoFluxBCs_SettlementOff_DepOn_201nodes_5d_Output12h_Implicit_dt5min_' #Prescribed by user
...
Simu.Total_TimeSteps = 3*4*24*5+1#60*38 #60*24 # Total number of timesteps
Simu.Output_Interval = 3*4*12#12*38 # One output every X timesteps
