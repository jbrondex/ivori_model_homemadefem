...
Simu.Name = 'Simu_Papier_Fig8_CC_3DOFs_cLumped_MassnotLumped_CalPar_Alpha5minus3_SettlementOn_DepOn_1001nodes_2d_Output3h_Implicit_dt1min_BCDirichlet_' #Prescribed by user
...
Simu.Output_Path = "./Output/Output_Fig8"  #path towards where the output will be stored
...
Mat.viscosity = 'MatLaw_ViscosityVionnetReduced_Phii_Temperature' #Parameterization of viscosity
