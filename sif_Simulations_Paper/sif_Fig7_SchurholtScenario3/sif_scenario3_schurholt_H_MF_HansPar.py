...
Simu.Name = 'Simu_Papier_Fig7_H_MF_cLumped_MassnotLumped_HansPar_SettlementOff_DepOn_1001nodes_1d_Output3h_Implicit_dt1min_NoBCDepRate_' #Prescribed by user
...
Simu.Total_TimeSteps = 60*24#60*38 #60*24 # Total number of timesteps
...
Mat.Keff = 'MatLaw_keffHansen_Phii_Temperature' #Parameterization used for calculation of Keff (MatLaw Calonne/Hansen or USF). Can also be a constant (prescribe a float then).
Mat.Deff = 'MatLaw_DeffHansen_Phii_Temperature' #Parameterization used for calculation of Deff (MatLaw Calonne/Hansen or USF). Can also be a constant (prescribe a float then).
