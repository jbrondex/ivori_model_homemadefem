...
Simu.Name = 'Simu_Papier_Fig7_CC_3DOFs_cLumped_MassnotLumped_ConstPar_Alpha5minus3_SettlementOff_DepOn_1001nodes_2d_Output3h_Implicit_dt1min_BCVapNoFlux_' #Prescribed by user
...
Mat.Keff = 0.2  #Parameterization used for calculation of Keff (MatLaw Calonne/Hansen or USF). Can also be a constant (prescribe a float then).
Mat.Deff = 1.066e-5  #Parameterization used for calculation of Deff (MatLaw Calonne/Hansen or USF). Can also be a constant (prescribe a float then).
...
#For the vapor solver
BC1.BCType_Rhov = 'No Flux' #Can be 'Rhov Flux' (Neumann), 'Given Rhov' (Dirichlet), 'No Flux' (Natural BC) or 'Rhov Balance' (Robin, not implemented yet)
...
#For the vapor solver
BC2.BCType_Rhov = 'No Flux' #Can be 'Rhov Flux' (Neumann), 'Given Rhov' (Dirichlet), 'No Flux' (Natural BC) or 'Rhov Balance' (Robin, not implemented yet)
