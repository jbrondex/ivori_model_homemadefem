...
Simu.Name = 'Simu_Papier_Fig1_CC_3DOFs_StdMass_cnotlumped_CalPar_Alpha5minus3_SettlementOff_201nodes_38h_Implicit_dt15min_' #Prescribed by user
...
Solver1.File = "Solvers.CoupledCalonneHeatVap_Solver_3DOFs_cnotlumped_StdMassMatrix" #In which file the solver is stored
