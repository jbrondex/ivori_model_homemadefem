...
Simu.Name = 'Simu_Papier_Fig1_CC_3DOFs_StdMass_cLumped_CalPar_Alpha5minus3_SettlementOff_201nodes_38h_Implicit_dt15min_' #Prescribed by user
...
Simu.Save_csv = True #False ### Do we want to save csv files ? True or False
Simu.Output_Path = "./Output/Output_Fig1" #path towards where the output will be stored
...
Solver1.File = "Solvers.CoupledCalonneHeatVap_Solver_3DOFs_cLumped_StdMassMatrix" #In which file the solver is stored
